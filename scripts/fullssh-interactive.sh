...
if [ $arg3 != "Compress" ] ; then
   chain="-v -E ~/Persistent/swtorcfg/log/ssh-command.log -o ServerAliveInterval=10 -"
else
   chain="-v -E ~/Persistent/swtorcfg/log/ssh-command.log -o ServerAliveInterval=10 -C"
fi
